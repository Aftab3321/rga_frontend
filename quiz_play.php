            ...
            makeAjaxCall("../scripts/requestAPI.php", "POST", FormData)
                .done((response) => {
                    ...
                    if (response.message.includes("completed Successfully")) {
                        ...
                        $(".risk_chart_info p.main-modal-para").html(modal_message[profile_id]);
                        $("#congratsModal").modal("show");
